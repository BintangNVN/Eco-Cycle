...
// IMPORT API
import { logout, getMyPosts, getCategories } from "../services/api/api";
...
type DashboardProps = {
  ...
  onMyPost?: () => void;
  onMyOrders?: () => void;
  onProfile?: () => void; // <-- Tambahan Prop untuk Profile
};
...
const PlasticIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M7 2h10l2 7H5l2-7z"/><rect x="5" y="9" width="14" height="11" rx="1"/><line x1="12" y1="9" x2="12" y2="20"/><circle cx="9" cy="15" r="0.5" fill="currentColor"/><circle cx="15" cy="15" r="0.5" fill="currentColor"/>
  </svg>
);
const GlassIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M6 3h12l-1 8c0 2-1 3-5 3s-5-1-5-3L6 3z"/><line x1="8" y1="14" x2="16" y2="14"/><path d="M7 14l-1 6c0 1 1 2 2 2h8c1 0 2-1 2-2l-1-6"/>
  </svg>
);
const TinIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="6" y="4" width="12" height="14" rx="1"/><line x1="6" y1="8" x2="18" y2="8"/><line x1="6" y1="12" x2="18" y2="12"/><path d="M9 2h6v2H9z"/><line x1="8" y1="19" x2="16" y2="19"/><line x1="9" y1="22" x2="15" y2="22"/>
  </svg>
);
const CardboardIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="3" y="3" width="18" height="18" rx="1"/><path d="M3 3l18 18"/><path d="M21 3L3 21"/><line x1="12" y1="3" x2="12" y2="21"/><line x1="3" y1="12" x2="21" y2="12"/>
  </svg>
);
const PatchworkIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="3" y="3" width="8" height="8"/><rect x="13" y="3" width="8" height="8"/><rect x="3" y="13" width="8" height="8"/><rect x="13" y="13" width="8" height="8"/><line x1="3" y1="11" x2="21" y2="11"/><line x1="11" y1="3" x2="11" y2="21"/>
  </svg>
);
const PaperIcon = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="5" y="2" width="14" height="20" rx="1"/><line x1="9" y1="7" x2="15" y2="7"/><line x1="9" y1="11" x2="15" y2="11"/><line x1="9" y1="15" x2="15" y2="15"/>
  </svg>
);
...
function ItemCard({ item, onViewDetails, catIcon }: { item: ExtendNearbyItem; onViewDetails: (item: NearbyItem) => void, catIcon?: ReactNode }) {
  ...
  const backendBaseUrl = "https://service-capstone-project.vercel.app/api";
  let imageUrl = "";
...
export default function Dashboard({ token, onLogout, initialCategoryId, onCategoryNavigate, onViewDetails, onMyPost, onMyOrders, onProfile }: DashboardProps) {
  ...
  const filteredNearby = useMemo(() => {
    const baseItems = apiPosts.slice(0, 6); 
  ...
  return (
    <div className="eco-app">
      {/* KITA PANGGIL KOMPONEN NAVBAR DI SINI */}
      <Navbar 
        token={token}
        ...
        onProfile={onProfile} // Lempar fungsi onProfile ke Navbar
        showSearch={true}
      />
